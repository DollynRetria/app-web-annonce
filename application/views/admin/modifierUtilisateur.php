<?php $this->load->view('admin/includes/header');?>
	<div class="formContent">
        ...
        <?php if(is_array($utilisateur)):?>
            <form id="inscription" method="post" action="<?php echo site_url('utilisateur/updateDataUser')?>">
                ...
                <div class="formBox">
                    <label>Email *</label>
                    <input type="text" class="inputText" name="email" id="email" value="<?php echo $utilisateur[0]['user_email']?>"/><label id="mailError"></label>
                </div>
                <div class="formBox">
                	<?php 
                    ...
                    <input type="text" class="inputText" value="<?php echo $zAnnee?>" name="annee" id="annee" style="width:100px"/>
                    <div class="clear"></div>
                </div>
                <div class="clear"></div>
                <div class="formBox">
                ...
                <div class="formBox">
                    ...
                    <input type="text" class="inputText" name="pass" id="password" value="<?php echo $utilisateur[0]['user_mot_de_passe']?>"/>
                </div>
                ...
                <div class="formBox">
                	<?php if(!empty($utilisateur[0]['user_photo'])):?>
                    	<label>&nbsp;</label>
                        <div class="inputText" style="height:auto; background:#fff">
                    		<img src="<?php echo base_url().'assets/media/utilisateur/mini_'. $utilisateur[0]['user_photo'] ?>" alt="" width="50" style="float:left"/>
                            <a href="<?php echo site_url('utilisateur/deleteTof/' . $utilisateur[0]['user_id'])?>" style="float:left; margin:0 5px"><img src="<?php echo base_url().'assets/images/' . 'error.png' ?>" alt="" title="supprimer"/></a>
                            <div class="clear"></div>
                        </div>
                    <?php else:?>
